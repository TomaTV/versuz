export default function SkillLoading() {
  return (
    <div>
      ...
      >
        <div className="vz-skeleton" style={{ width: 140, height: 11, marginBottom: 64 }} />
        <div className="vz-skeleton" style={{ width: 220, height: 11, marginBottom: 24 }} />
        <div className="vz-skeleton" style={{ width: "70%", height: 120, marginBottom: 32 }} />
        ...
        <div className="vz-skeleton" style={{ width: 240, height: 48 }} />
      </section>
