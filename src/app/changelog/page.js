...
const ENTRIES = [
  {
    date: "2026-05-16",
    title: "V1.7 — /best 404 fix + audit hygiene + observability rolled back",
    items: [
      ...
      { type: "infra", body: "Observability rolled back — PostHog + Sentry were wired earlier in the session but added more friction than value at this stage (no funnels worth measuring with 50 visitors, dashboards confused between project keys). Both removed : posthog-js + @sentry/nextjs uninstalled, all provider / instrumentation / event files deleted, next.config Sentry wrap dropped. Sole remaining analytics layer : Vercel Analytics + Speed Insights." },
